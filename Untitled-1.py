...
def translate_text():
    ...
    Payload: { "text": str, "source_lang": str, "target_lang": str }
    """
...
def detect_language():
    ...
    return jsonify({'success': True, 'detected_lang': detected})
...
def service_worker():
    """
    Serve the service worker from the ROOT path (not /static/js/) so its
    scope covers the entire site. 'Service-Worker-Allowed' header lets a
    file physically living under /static/js/ still control the whole app.
    """
...
if __name__ == '__main__':
    ...
    print("Starting Language Translator Server at http://0.0.0.0:5000 ...")
